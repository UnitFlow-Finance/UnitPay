/**
 * Official brand marks for X (Twitter) and Discord, as inline SVGs.
 * lucide-react dropped its brand icon set, so these are sourced directly
 * from each platform's public brand assets (simple, single-path glyphs)
 * and rendered as `currentColor` so they inherit text color like any
 * other icon in this codebase.
 */
